...
exports.routeConfig = function(app) {
  ...
  app.post("/product", [ProductController.insert]);
  ...
  app.patch("/product/:product_id", [ProductController.patchById]);
  app.delete("/product/:product_id", [ProductController.removeById]);
};
